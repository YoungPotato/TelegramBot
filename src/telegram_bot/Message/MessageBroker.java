...
public class MessageBroker {
    private final List<String> amount = Arrays.asList("500 руб.", "1000 руб.", "2000 руб.", "3000 руб.", "5000 руб.", "10 000 руб.",
    ...
    public SendMessage getAmountButtons() {
        InlineKeyboardMarkup inlineKeyboardMarkup = new InlineKeyboardMarkup();
